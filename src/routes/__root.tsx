...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Abdi Adde — Cinematic Portfolio" },
      { property: "og:description", content: "Filmmaker · Storyteller · Digital Architect. Half a million strong audience." },
